# GU IRB Account 
- The GU IRB system is called [GU-Medstar](https://gumedstarirb.georgetown.edu) (Note: GU used to use an electronic IRB system called [eRIC](http://eric.georgetown.edu), which was discontinued on May 1, 2019)
