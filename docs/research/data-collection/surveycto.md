...
1. Create a Google Doc document in the Project [folder](../../onboarding/workflow/folder-structure.md) following the [Gdoc survey template]() to define survey modules and survey questions
...
1. Duplicate the Google Sheet of the old survey in the Project [folder](../../onboarding/workflow/folder-structure.md) 
