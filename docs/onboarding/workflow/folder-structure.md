...
Full detail is in the [gui2de folder protocol](https://docs.google.com/document/d/1dP73iDZsJAcwM0IjeliZnXFk6kR-SeRrsbmF8_t-MZs/edit). The essentials:
...
- **Folders must be gui2de-created.** If your project has no folder, or you cannot access it, ask your project manager or the Executive Director. Existing folders are listed [here](https://docs.google.com/spreadsheets/d/1iq0d_jkqFv95JkLRjGV37CiFThAKxGvDZ8n-GPU7bdY/edit).
...
Box Drive and Google Drive do not download files onto your computer unless you ask them to sync a
folder for offline access, so they should not take up space on your laptop.
